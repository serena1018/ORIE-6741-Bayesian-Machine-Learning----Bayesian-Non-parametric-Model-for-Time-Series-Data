...
if isfield(hypers, 'alpha0')
    ...
    %gamrnd(A,B) generates random numbers from the gamma distribution with shape parameters in A and scale parameters in B
end
...
%while iter <= 10
    ...
    % Not  sure about this need to do more research
    E = zeros(sample.K, 2);
    for t=1:T
    ...
    N(1, sample.S(1)) = 1;
    %Empirical count of state (sum) = 1267 
    for t=2:T
